...
// paire propre, ou un refus en francais. Bornes : 730 jours (deux ans, ce que
// les plateformes acceptent) et 24 mois. `Number(true)` vaut 1 : on exige un
// entier, la valeur peut arriver en chaine depuis un formulaire.
const FENETRE_MAX = { jours: 730, mois: 24 }
function validerFenetre (entree) {
  ...
  if (valeur > FENETRE_MAX[type]) {
    return { ok: false, code: 'fenetre_trop_longue', error: `Au plus ${FENETRE_MAX[type]} ${type} : au-delà, les plateformes n'acceptent plus les dates.` }
  }
