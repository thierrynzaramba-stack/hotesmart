  ...
  for (const d of DATES) {
    ...
    for (const o of occurrences(d, debut, fin)) {
      ...
      out.push({
        ...
        // `suggerer`, par `segmenterSansEvenements`) : c'est plus juste qu'un
        // parent decrete, qui perdrait le jour de semaine ET la saison.
        // ⚠ JUSQU'AU 23 SEPTEMBRE 2026 CE COMMENTAIRE ETAIT FAUX : le repli
        // tombait sur un jour ordinaire hors vacances (reveillon a 125 € entre
        // deux nuits de Noel a 155 €). KB suggestion-yield §3 bis.
        parent_segment: null,
        origine: 'commercial',
        cle: o.cle,
