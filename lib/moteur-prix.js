...
function calculerPrix ({ aujourdHui, fin, lignes, fermetures, prix, ouverts = null }) {
  const comptes = { calculees: 0, changees: 0, inchangees: 0, non_calculables: 0, sous_plancher: 0,
    fermees: 0, fermees_par_l_hote: 0, vendues: 0, sans_ligne: 0, ouverture_inconnue: 0 }
  const motifs = {}
  const changements = []
...
async function entretenirLesPrix (supabase, bien, deps = {}) {
  ...
  const decision = calculerPrix({ aujourdHui: auj, fin, lignes, fermetures, ouverts,
