...
function rangDansSonRegime (s) {
  ...
  if (r < 0) throw new RegimesMelanges(`saison inconnue : ${s && s.saison}`)
  return r
}
...
module.exports = { calendrierDuMarche, RegimesMelanges, REGIMES, rangDansSonRegime, comparerSaisons, ordonnerSaisons, saisonDuJour, formeMensuelle, lirePacing, lisser, SEUIL_NUITS_JOUR, SAISONS, NOM_SAISON, QUANTILES }
