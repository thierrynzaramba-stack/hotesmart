...
// Deux writers alimentent bookings_snapshot (ce fichier + lib/channels/beds24.js),
// avec des normalisations differentes : l'un ecrit `0` enfant, l'autre `null`
// (`0 || null`). Sans neutraliser cet ecart, chaque cycle cron rejuge le booking
// "modifie" (null -> 0) en boucle. On considere donc null/undefined/0 comme egaux
// pour les compteurs voyageurs, et ''/null comme egaux pour les chaines.
