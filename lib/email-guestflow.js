...
async function envoyerEmailVoyageur ({ userId, destinataire, sujet, texte, propertyId, propertyName }) {
  ...
  return await envoyerHtmlVoyageur({
...
//
// Les deux modules gardaient chacun leur enveloppe ; celui-ci devient le seul
// chemin vers Brevo pour ce qui part au voyageur.
async function envoyerHtmlVoyageur ({ userId, destinataire, sujet, html, propertyId, propertyName }) {
