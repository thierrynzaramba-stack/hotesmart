...
const LABELS = {
  ...
  // Le mode auto-pilote (lots 4.6.3-4.6.5) : lib/pilote-quotidien.js.
  pilote_poussee_refusee: 'YIELDFLOW — ouverture ou prix mémorisés mais NON POUSSÉS au canal (full sync en file)',
  pilote_sans_prix:       'YieldFlow — des nuits de la fenêtre restent fermées faute de prix',
  pilote_regle_muette:    'YieldFlow — la règle ne sait tarifer aucune nuit ouverte, les prix en place restent',
  pilote_en_retard:       'YIELDFLOW EN RETARD — aucun passage du pilote depuis plus de 36 h',
  pilote_matiere_illisible: 'YieldFlow — matière du prix illisible, ouverture faite, prix non entretenus',
