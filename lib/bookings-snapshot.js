...
//
// On trie donc les cles recursivement avant de comparer. Les tableaux gardent
// leur ordre : dans un payload provider (invoiceItems, rooms, days_breakdown)
// l'ordre porte du sens, deux ordres differents sont deux payloads differents.
//
...
function empreinte(valeur) {
  ...
  return createHash('sha256').update(stableStringify(valeur)).digest('hex')
}
