...
async function processArrivalCodes(userId, beds24Key, property, bookings, results) {
  ...
  const todayArrival = (bookings || []).find(b => {
    ...
    return belongs &&
      ...
      // Source mixte : bookings Beds24 bruts (sans champ provider) et snapshots
      // channel. Defaut = provider du bien ; le provider porte par un snapshot
      // reste prioritaire.
...
module.exports = { processArrivalCodes, isMenageValidated }
