...
const CHAMPS_BIEN = 'id, user_id, name, city, country, currency, capacity, ' +
  ...
  'checkin_time, checkout_time, cancellation_policy, provider, provider_property_id, ' +
  // ⚠ LUS PAR `raisonNonVendable` : sans eux la garde d'ecriture CRS voit
  // `undefined` et laisse vendre un bien qu'on ne saura pas ecrire.
  'provider_room_type_id, provider_rate_plan_id'
