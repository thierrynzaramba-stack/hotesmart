...
function nuitsAOuvrir ({ bien, aujourdHui, lignes, fermetures, prixCalcule = null }) {
...
// ─── UN BIEN ─────────────────────────────────────────────────────────────────
async function ouvrirLaFenetreDuBien (supabase, bien, { aujourdHui, appel, demander = demanderAuCalendrier, prixCalcule = null, fermetures: fermeturesFournies = null } = {}) {
  ...
  const decision = nuitsAOuvrir({ bien, aujourdHui: auj, lignes, fermetures, prixCalcule })
