...
// ⚠ « Pas zero » ne suffit pas : un depart le lendemain a 15h59 UTC produisait
// une proposition valable UNE MINUTE, tuee par le passage de cron suivant. Un
// vrai delai de reponse, c'est le temps de lire un SMS et de repondre.
const DELAI_MINIMUM_MS = 2 * 3600 * 1000
function echeanceOffre (departureDate, maintenant = Date.now()) {
  ...
  if (limite - maintenant < DELAI_MINIMUM_MS) return null
...
module.exports = { chargerLiaisons, choisirPrestataire, horodatages, echeanceOffre, SANS_OFFRE, HEURES_OFFRE, DELAI_MINIMUM_MS }
