...
function choisirPrestataire (liaisons, { mode = 'priorite' } = {}) {
  ...
  return {
    providerId: retenue.providerId,
    rang: retenue.rang,
    referent,
    // Le referent est engage d'office ; le suppleant recoit une offre.
    status: referent ? 'accepted' : 'offered',
    assignedBy: 'auto',
    aucuneLiaison: false,
    raison: referent
      ? 'Referent du bien (rang 1), assigne d\'office.'
      : `Suppleant (rang ${retenue.rang}) : en attente de sa confirmation.`,
    mode
  }
}
...
module.exports = { chargerLiaisons, choisirPrestataire, horodatages }
